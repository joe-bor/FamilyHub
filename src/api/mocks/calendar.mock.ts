...
const eventTemplates = [
  { title: "Coffee with Diana", memberId: "1", startTime: "9:00 AM", endTime: "10:00 AM" },
  { title: "Pickup Day Cleaning", memberId: "6", startTime: "8:00 AM", endTime: "9:00 AM" },
  { title: "Soccer Practice", memberId: "4", startTime: "4:00 PM", endTime: "5:30 PM" },
  { title: "Emma's Birthday Party", memberId: "3", startTime: "2:00 PM", endTime: "5:00 PM" },
  { title: "Grocery Run", memberId: "1", startTime: "11:00 AM", endTime: "12:00 PM" },
  { title: "Dogo's Bath Day!", memberId: "6", startTime: "10:00 AM", endTime: "11:00 AM" },
  { title: "Amelia's Baby Shower", memberId: "1", startTime: "1:00 PM", endTime: "3:00 PM" },
  { title: "Tutoring", memberId: "3", startTime: "3:30 PM", endTime: "4:30 PM" },
  { title: "Mincey Toss", memberId: "4", startTime: "9:00 AM", endTime: "10:00 AM" },
  { title: "House Cleaner Estimate", memberId: "2", startTime: "10:00 AM", endTime: "11:00 AM" },
  { title: "Dance Group", memberId: "5", startTime: "5:00 PM", endTime: "6:30 PM" },
  { title: "Lunch With Mom", memberId: "1", startTime: "12:00 PM", endTime: "1:30 PM" },
  { title: "Harvest Festival", memberId: "6", startTime: "10:00 AM", endTime: "2:00 PM" },
  { title: "Pop Rally", memberId: "3", startTime: "2:00 PM", endTime: "3:00 PM" },
  { title: "Volleyball Practice", memberId: "3", startTime: "4:00 PM", endTime: "5:30 PM" },
  { title: "Math Tutoring", memberId: "4", startTime: "3:00 PM", endTime: "4:00 PM" },
  { title: "Luna Vet Checkup", memberId: "1", startTime: "2:00 PM", endTime: "3:00 PM" },
  { title: "Volleyball Game", memberId: "3", startTime: "6:00 PM", endTime: "8:00 PM" },
  { title: "Reading Time", memberId: "5", startTime: "7:00 PM", endTime: "8:00 PM" },
]
...
function createMutationResponse<T>(data: T, message: string): MutationResponse<T> {
  return { data, message }
}
...
export const calendarMockHandlers = {
  ...
  async updateEvent(request: UpdateEventRequest): Promise<MutationResponse<CalendarEvent>> {
    ...
    mockEvents = [...mockEvents.slice(0, index), updatedEvent, ...mockEvents.slice(index + 1)]
