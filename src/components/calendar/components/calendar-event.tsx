    ...
    return (
      ...
      >
        <div className="flex items-start gap-3 h-full">
          <div className={cn("w-2 rounded-full shrink-0 self-stretch", colors?.bg)} />
    ...
    return (
      ...
      >
        <div className="flex items-start gap-2 h-full">
          <div className={cn("w-1.5 rounded-full shrink-0 self-stretch", colors?.bg)} />
          <div className="flex-1 min-w-0">
            <h4 className={cn("font-semibold text-sm leading-tight line-clamp-3", colors?.text)}>
              {event.title}
            </h4>
          </div>
        </div>
